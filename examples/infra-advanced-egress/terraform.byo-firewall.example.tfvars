...
machines_byo_firewall_private_ip = "10.10.0.4"

# BYO firewall setting used only when machines_egress_mode = "firewall_customer_existing".
# Module uses this existing route table and associates machines subnet to it.
