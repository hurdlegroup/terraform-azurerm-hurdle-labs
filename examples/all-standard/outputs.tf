// These outputs intentionally re-export the root module API; nested module internals are scope-isolated.
...
output "machines_managed_firewall_id" {
  ...
  value       = module.hurdle_labs.machines_managed_firewall_id
}
...
output "bridge_appgw_public_ip" {
  ...
  value       = module.hurdle_labs.bridge_appgw_public_ip
}
...
output "bridge_appgw_public_fqdn" {
  ...
  value       = module.hurdle_labs.bridge_appgw_public_fqdn
}
...
output "bridge_appgw_waf_policy_id" {
  ...
  value       = module.hurdle_labs.bridge_appgw_waf_policy_id
}

output "bridge_vm_id" {
  description = "ID of the persistent bridge VM."
  value       = module.hurdle_labs.bridge_vm_id
}

output "bridge_vm_name" {
  description = "Name of the persistent bridge VM."
  value       = module.hurdle_labs.bridge_vm_name
}
...
output "bridge_nsg_id" {
  ...
  value       = module.hurdle_labs.bridge_nsg_id
}

output "bridge_nsg_name" {
  description = "Name of the bridge Network Security Group."
  value       = module.hurdle_labs.bridge_nsg_name
}
