...
output "machines_nat_gateway_id" {
  ...
  value       = try(azurerm_nat_gateway.machines[0].id, null)
}
...
output "machines_route_table_id" {
  ...
  value       = local.is_nat_mode ? null : (local.use_byo_route_table ? try(data.azurerm_route_table.byo[0].id, null) : try(azurerm_route_table.machines_egress[0].id, null))
}
...
output "machines_managed_firewall_id" {
  ...
  value       = try(azurerm_firewall.managed[0].id, null)
}
...
output "machines_managed_firewall_private_ip" {
  ...
  value       = try(azurerm_firewall.managed[0].ip_configuration[0].private_ip_address, null)
}
...
output "bridge_appgw_id" {
  ...
  value       = try(azurerm_application_gateway.bridge[0].id, null)
}
...
output "bridge_appgw_public_ip" {
  ...
  value       = try(azurerm_public_ip.bridge_appgw[0].ip_address, null)
}
...
output "bridge_appgw_public_fqdn" {
  ...
  value       = try(azurerm_public_ip.bridge_appgw[0].fqdn, null)
}
...
output "bridge_appgw_waf_policy_id" {
  ...
  value       = try(azurerm_web_application_firewall_policy.bridge[0].id, null)
}
